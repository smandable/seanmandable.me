...
Debt Descent is a native debt-payoff planner for iPhone, iPad, and Mac. Add your debts, compare the Snowball and Avalanche methods, and see exactly when you'll be debt-free — with no account, no sign-up, and nothing ever sent to me.

### Frequently asked questions

**Is my financial data private?**
Yes — completely. Your data lives on your device and in your own private iCloud, where I can't see it. There are no accounts, no servers of my own, and no analytics. See the [Privacy Policy](/debt-descent/privacy).
...
Yes — payment groups are free for everyone. On the Payments tab, add a payment group, pick the debts it covers, and enter the monthly amount that actually reaches them. Log the payment once and Debt Descent splits it across the group to the cent — following the servicer's own schedule when every member has a fixed payment. If your plan keeps a fee (it drafts more than it sends to your creditors), record that in the **Plan fee** field: the app then matches your bank statement without letting the fee flatter your payoff projection.
...
**How do I start over?**
Use **Purge All Data** (••• menu) to erase everything and start blank. On an empty app the menu also offers **Load Sample Data**, a fabricated demo set — it only appears while there are no debts, so it can't replace real data by accident.
