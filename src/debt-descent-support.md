...
It should unlock automatically when you're signed in with the same Apple Account. If not, open the paywall (tap any "PRO" feature, or the ••• menu, then "Unlock Debt Descent Pro") and tap **Restore Purchases**.
